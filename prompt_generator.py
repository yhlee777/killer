# 35K 토큰 마케팅 보고서 (시스템 프롬프트) - 사용자 제공 원문
...
12개 질문 답변 → Claude용 맞춤형 프롬프트 생성
"""

from typing import Dict, Any

# 35K 토큰 마케팅 보고서 (시스템 프롬프트)
MARKETING_REPORT_SYSTEM_PROMPT = """
당신은 한국 요식업 마케팅 전문가입니다.
아래는 50+ 학술 논문과 글로벌 사례 연구를 종합한 완벽 가이드입니다.
...
- 62%가 Google로 레스토랑 발견
- 한국: 78%가 방문 전 Naver Place 확인
- 36% TikTok 사용자가 영상 시청 후 레스토랑 방문

## 마케팅 철학별 분류

### A. 제품 중심 마케팅 (Product-Led)
**철학:** "제품이 말하게 하라"
**핵심 방법:** 시그니처 메뉴, 장인정신, 인스타그램어블 플레이팅
**적합 업종:** 프리미엄 레스토랑, 장인 카페

### B. 데이터 드리븐 마케팅 (Data-Driven)
**철학:** "측정할 수 없으면 개선할 수 없다"
**핵심 방법:** A/B 테스팅, 전환율 최적화, Google Analytics
**핵심 지표:** CAC, ROAS, 전환율, CLV:CAC 비율
**적합 업종:** 체인, 배달 중심, 성장 단계

### C. 바이럴 마케팅 (Viral/WOM)
**철학:** "고객이 우리의 가장 큰 마케터"
**핵심 방법:** TikTok 챌린지, 인스타그램어블 공간, UGC 캠페인
**통계:** 36% TikTok 사용자가 영상 후 방문
**ROI:** 성공 시 무한대, 예측 불가능

### D. 브랜딩 중심 마케팅 (Brand-Led)
**철학:** "브랜드는 경험과 감정"
**핵심 방법:** 일관된 브랜드 아이덴티티, 창업 스토리
**ROI:** 장기 (6-24개월), 지속 가능

### E. 퍼포먼스 마케팅 (Performance)
**철학:** "모든 원화는 측정 가능한 결과"
**핵심 방법:** Google Ads, Facebook/Instagram 광고, Naver 검색광고
**ROI by Channel:** Google Ads 8:1, Facebook 3:1~5:1, 이메일 15:1~25:1

### F. 커뮤니티/팬덤 마케팅
**철학:** "고객을 브랜드 옹호자로"
**핵심 방법:** 로열티 프로그램, 게이미피케이션, VIP 멤버십
**통계:** 로열티 회원은 비회원보다 3배 지출

### G. 콘텐츠 마케팅 (Content)
**철학:** "가치를 먼저 제공"
**핵심 방법:** 블로그, YouTube, TikTok/Reels, 이메일 뉴스레터
**ROI:** 전통 마케팅보다 62% 저렴, 3배 더 많은 리드

### H. 인플루언서 마케팅
**계층별 전략:**
- 나노 (1K-10K): 참여율 14.2%, 비용 $10-150, ROI 최고
- 마이크로 (10K-100K): 참여율 6%, 비용 $100-1,000
- 매크로 (500K-1M): 참여율 2.65%, 비용 $5K-10K+

### I. 로컬/지역 마케팅
**철학:** "동네를 정복하라" (3km 반경)
**핵심 방법:** Google My Business / Naver Place 최적화 (최우선!)
**통계:** 
- 62% Google로 레스토랑 발견
- 한국 78% Naver Place 확인
- 반 별 차이 = 27% 비즈니스 변동
...
### Instagram
- 23.5억 사용자, F&B 참여율 4.13%
- 60%가 Instagram으로 새 레스토랑 발견
- Reels: 30.81% 도달률, 7-15초 최적
- 베스트 시간: 수요일 11AM-1PM
...
**보편적 진리:**
1. 이메일 최고 ROI (15-25:1)
2. SEO 최고 장기 (22:1)
3. 로컬 인플루언서가 셀럽보다 효과적
4. 소규모 테스트 먼저
5. 브랜드 정렬이 기회 크기보다 중요

**즉시 실행 (1주차):**
- GMB/Naver Place 완전 최적화
- Instagram/TikTok 계정 생성
- 사진 20장 준비
- 이메일 수집 시작

**한국 레스토랑 특별:**
- 한류와 K-food 글로벌 성장
- 시각적 매력이 Instagram/TikTok 완벽 매치
- 문화적 진정성 > 서양화
- Naver가 Google보다 중요
...
def generate_owner_profile_text(answers: Dict[str, str]) -> str:
    """
    12개 질문 답변 → 사장님 프로필 텍스트 생성
    """
...
### 1. 우선순위 채널 TOP 3
- 예산, 시간, 역량을 고려한 현실적인 채널
- 각 채널별 구체적 실행 방법
- 예상 ROI와 시간 프레임

### 2. 2주 액션 플랜
- 즉시 실행 가능한 구체적 액션 (Step-by-Step)
- 각 액션의 소요 시간과 비용
- 측정 가능한 KPI
...
1. **우리 상황에 맞지 않는 전략은 언급하지 마세요**
   - 예산 없으면 유료 광고 제외
   - 시간 없으면 매일 관리 필요한 것 제외
   - 초보면 복잡한 분석/SEO 제외
...
4. **간결하고 실용적으로**
   - 긴 이론 설명 불필요
   - 바로 실행할 수 있는 체크리스트 형식
   - 사장님이 이해하기 쉬운 언어

출력 형식: Markdown, 명확한 섹션 구분, 체크박스 사용
"""
...
def generate_full_prompt(
    ...
    # 사장님 프로필 생성
    owner_profile_text = generate_owner_profile_text(answers)
    ...
    return MARKETING_REPORT_SYSTEM_PROMPT, user_prompt